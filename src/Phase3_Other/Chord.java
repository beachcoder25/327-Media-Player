...
public class Chord extends java.rmi.server.UnicastRemoteObject implements ChordMessageInterface {
    ...
    public Chord(int port, long guid) throws RemoteException {
        ...
        for (j = 0; j < M; j++) {
            finger[j] = null; // If M =2 only two indexes of finger[] are null... Significance of this?
        }
        this.guid = guid;
        nextFinger = 0;
        predecessor = null;
        ...
        try {
            ...
            System.out.println("Exception thrown in chord?");
            throw e;
        }
    }
    ...
    /**
     * If the successor fails, it tries to handle the failure using the first
     * finger available
     * <p>
     */
     ...
     * present it sets its predecessor to null. This method executed by the
     * timer.
     */
     ...
     * <p>
     * It checks if the successor is still alive. If the succesor is not present
     * it joins its successor. This method executed by the timer.
     */
